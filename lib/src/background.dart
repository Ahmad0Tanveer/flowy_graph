...
abstract class FlowyBackgroundBase {
  const FlowyBackgroundBase();

  void paint(Canvas canvas, Size size);
}

class SolidBackground extends FlowyBackgroundBase {
  final Color color;
...
class GridBackground extends FlowyBackgroundBase {
