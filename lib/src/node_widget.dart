...
abstract class NodeWidgetBase {
  ...
  void selectNode(BuildContext context) {
    FlowyNodeController controller = ControllerInheritedWidget.of(
      context,
    ).controller;
...
class NodeEditorInheritedWidget extends InheritedWidget {
  NodeEditorInheritedWidget({super.key, required this.blueprintNode})
    : super(child: NodeWidget(blueprintNode: blueprintNode));

  final NodeWidgetBase blueprintNode;

  static NodeEditorInheritedWidget of(BuildContext context) {
    final NodeEditorInheritedWidget? result = context
        .dependOnInheritedWidgetOfExactType<NodeEditorInheritedWidget>();
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: iconTileSpacing),
                          DefaultTextStyle(
  ...
  Widget customBuild(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [inputPort, label, outputPort],
        ),
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Column(children: [inputPort1, inputPort2]),
            label,
            outputPort,
          ],
        ),
