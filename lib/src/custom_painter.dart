...
class FlowyCanvas extends StatefulWidget {
  const FlowyCanvas({
    Key? key,
  ...
  @override
  State<FlowyCanvas> createState() => _FlowyCanvasState();
}

class _FlowyCanvasState extends State<FlowyCanvas> {
              ...
              return ControllerInheritedWidget(
                ...
                child: LayoutBuilder(
                  builder: (BuildContext context, BoxConstraints constraints) {
                    widget.controller.currentScreenSize = Size(
  ...
  void _onKey(KeyEvent event) {
    ...
    if (isShift) {
      widget.controller.isShiftPressed = event is KeyDownEvent;
    }
